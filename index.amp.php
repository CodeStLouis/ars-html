...
<div class="page-wraper">
    ...
    <div class="page-content">
        ...
        <div class="main-slider style-two default-banner">
            <div class="tp-banner-container">
                <div class="tp-banner">
                    ...
                    <div class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect"
                         data-source="gallery" id="rev_slider_1014_1_wrapper">
                        <div class="rev_slider fullscreenbanner" data-version="5.4.1" id="rev_slider_1014_1"
                             style="display:none;">
                            <ul>
                                <!-- SLIDE 1 -->
                                <li data-description="" data-easein="default" data-easeout="default"
                                    data-hideafterloop="0" data-hideslideonmobile="off" data-index="rs-1000"
                                    data-masterspeed="2000" data-param1="01"
                                    ...
                                    <img alt="St Louis Roofing and Construction" class="rev-slidebg" data-bgfit="cover"
                                         ...
                                         data-no-retina height="700"
                                         layout="responsive" src="images/ars/big-roof.jpg" width="1903"/>
                                    <!-- LAYERS -->
                                    ...
                                    <div class="rs-background-video-layer"
                                         ...
                                         data-videoloop="loop"
                                         data-videomp4="https://ARS-Construction.b-cdn.net/ars_building.mp4"
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                        <span class="text-uppercase" style="font-family:'Roboto' ;">Roofing</span>
                                    </div>
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                        <span class="text-uppercase" style="font-family:'Roboto' ;">Done Right</span>
                                    </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                         ...
                                         data-height="['none','none','none','none']" data-hoffset="['0','0','0','0']"
        ...
        <div class="section-full overlay-wraper bg-cover bg-repeat-x bg-primary"
             style="background-image:url(images/background/bg7.png)">
            <div class="container">
                ...
                >
                        ...
                        <!-- SLIDER 1 -->
                        <div class="item">
                            <a href="https://www.iko.com/" target="_blank">
                                <amp-img
                                        src="images/ars/iko-roofpro-sm.png"
                                        width="200"
                                        height="200"
                                        alt="IKO Roofing Pro"
                                        layout="flex-item"
                        ...
                        <!-- SLIDER 2 -->
                        <div class="item">
                            <a href="https://www.genflex.com/" target="_blank">
                                <amp-img
                                        src="images/ars/genflex-sm.png"
                                        width="200"
                                        height="200"
                                        alt="Gen Flex Roofing"
                                        layout="flex-item"
                                >
                                </amp-img>
                            </a>
                        ...
                        <!-- SLIDER 4 -->
                        <div class="item">
                            <a href="https://www.bbb.org/us/mo/wildwood/profile/general-contractor/advanced-roofing-systems-construction-llc-0734-310230062/#sealclick target="
                               _blank">
                            <amp-img
                        ...
                        <div class="item">
                            <a href="https://app.gethearth.com/financing/15237/19452?utm_campaign=15237&utm_content=general&utm_medium=contractor-website&utm_source=contractor&utm_term=19452"
                               target="_blank">
                                <amp-img
                                        src="images/ars/150x150_hearth_badge.png"
                                        width="200"
                                        height="200"
                        ...
                        <!-- SLIDER 6 -->
                        <div class="item">
                            <a href="https://usio.com/" target="_blank">
                                <amp-img
                                        src="images/ars/final-usio-color.png"
                                        width="200"
                                        height="200"
                                        alt="Usio Payment Solutions"
                                        layout="flex-item"
                                >
                                </amp-img>
                            </a>
                        ...
                        <!-- SLIDER 7 -->
                        <div class="item">
                            <a href="https://eagleroofing.com/" target="_blank">
                                <amp-img
                                        src="images/ars/eagle-roofing-logo.png"
                                        width="200"
                                        height="200"
                        ...
                        <!-- SLIDER 8 -->
                        <div class="item">
                            <a href="https://gaco.com/" target="_blank">
                                <amp-img
                                        src="images/ars/gaco-logo.png"
                                        width="200"
                                        height="200"
                                        alt="Gaco"
                                        layout="responsive"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>Our motivated team of experienced contractors are ready to take on any construction tasks. As
                            mention in the Better Business Burro,
                            reflected in out 5 start rating review on Google, ARS strives to meet customer demand with
                            the best quality of craftsman ship.
                            We have tools to give online estimates as well as on site estimates. ARS offers Free roof
                            inspections and if we find issues our team is experienced
                ...
                <div class="container">
                    <div class="owl-carousel Home-services-carousel owl-btn-vertical-center">
                            ...
                            <div class="wt-box bg-white">
                                <div class="wt-media">
                                    <a href="javascript:void(0);"><img alt="Interior General Contracting"
                                                                       src="images/ars/kitchen-contracting.jpg"></a>
                                </div>
                                <div class="wt-info p-tb30">
                        ...
                        <div class="item">
                            <div class="wt-box bg-white">
                                <div class="wt-media">
                                    <a href="javascript:void(0);"><img alt="Custom Roofing "
                                                                       src="images/ars/different-hous.jpg"></a>
                                </div>
                                <div class="wt-info p-tb30">
        ...
        <div class="section-full p-t80 p-b50 overlay-wraper bg-parallax" data-stellar-background-ratio="0.5"
             style="background-image:url(images/ars/crane.jpg)">
            <div class="overlay-main bg-black opacity-07"></div>
            <div class="container">
                <!-- TITLE START -->
                <div class="section-head text-center text-white">
                    <h2 class="text-uppercase">Our 5 Star Ratings on Google Reviews</h2>
                    <div class="wt-separator-outer">
        ...
        <div class="section-full bg-gray p-t80 p-b120 bg-no-repeat bg-bottom-right"
            ...
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head text-center">
                    <h2 class="text-uppercase">What we are up to</h2>
                    <div class="wt-separator-outer">
                        <div class="wt-separator style-square">
                            <span class="separator-left bg-primary"></span>
                            <span class="separator-right bg-primary"></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="m-b30 text-white text-center">
                                ...
                                <div class="font-26 font-weight-800 m-b5"><span class="counter">50</span><b>+</b></div>
