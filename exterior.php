...
<div class="page-wraper">
    ...
    <div class="page-content">
        ...
        <!-- INNER PAGE BANNER -->
        <div class="wt-bnr-inr overlay-wraper" style="background-image:url(images/ars/residentail-roof2.jpg);">
            <div class="overlay-main bg-black opacity-07"></div>
            <div class="container">
                <div class="wt-bnr-inr-entry">
                    <h1 class="text-white">Exterior Home Improvements</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                            ...
                            <div class="item">
                                ...
                                <div class="wt-info p-tb30">
                                    ...
                                    <p>ARS Construction is the expert when it comes to repairing and installing your
                                        ...
                                        when it comes to the exterior of your home. They prevent the environment outside
                                        from affecting the home and the foundation. It is definitely important that you
                                        make sure both are working correctly. If you are not quite sure what to look
                                        for, give us a call and one of our contractors will meet with you and give you a
                                        free quote right on the spot. </p>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="wt-info p-tb30">
                                    ...
                                    <p>Do you have a broken window? Is it time to update your windows to a more modern
                                        ...
                                        your home. We have a wide range of styles for you to choose from. They are
                                        durable but stylish to fit your unique style. For more information, talk to one
                            ...
                            <div class="item">
                                ...
                                <div>
                                    ...
                                    <p>Having a door that is stylish but functional is an easy thing to do when you call
                                        ARS
                                        Construction. We have a wide range of styles to choose from and also come in
                                        different finishes to match the style of your home. If you are not sure, call us
                                        today and together we can come up with a plan that works for you. We make sure
                                        to
                                        not cut corners when it comes to installing your doors. We use the latest
                                        equipment
                                        to ensure that the job is done right to better protect you and your family.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="text-justify">
                            <h2 class="text-uppercase">Exterior Home Improvements</h2>
                            <p>Does the outside of your home need updates? Need repairs done to your siding or gutters?
                                If so, let ARS Construction be the ones to help bring your home to the next levels. We
                                specialize in the repairs and installation of your siding, gutters, windows, and doors.
                            </p>
                            <p>Since 2001, we have provided top-quality work for our clients in Eureka, Wildwood, and
                                the surrounding communities. Our top priority is to make sure that we are not complete
                                with the job until you are 100% satisfied. To get started, call us today!</p>
                        </div>
                    </div>
                </div>
            </div>
